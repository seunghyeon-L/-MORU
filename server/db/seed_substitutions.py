...
MENU_ALTERNATIVES = {
    ...
    # ── 나머지 음식들 ──
    #
    # ★ 이미 FODMAP 이 낮은 음식에는 대체안을 달지 않는다.
    #   김밥(0.00) · 비빔밥(0.12) · 계란말이(0.15) · 샐러드(0.15) 같은 것들.
    #   괜찮은 음식에 "이건 어떠세요" 를 띄우면 그 자체가
    #   "지금 먹는 게 문제" 라는 판정이 된다. (절대 원칙 ①)
    #   H4 는 대체안이 없으면 그 옵션을 아예 안 보여준다.
    #
    #   한국 음식의 FODMAP 은 대부분 양파·마늘에서 온다.
    #   그래서 대체안도 "같은 음식의 순한 버전" 이 가장 현실적이다.

    "된장찌개": [
        ("맑은 순두부탕", "양파·마늘 없이 담백해요.", 1),
        ("미역국", "국물이 순해요.", 2),
    ],
    "순두부찌개": [
        ("맑은 순두부탕", "같은 두부인데 양념이 순해요.", 1),
        ("계란찜", "부드럽고 자극이 없어요.", 2),
    ],
    "부대찌개": [
        ("떡국", "국물이 맑고 부담이 덜해요.", 1),
        ("맑은 순두부탕", "자극적인 양념이 없어요.", 2),
    ],
    "불고기": [
        ("간장 돼지고기 덮밥", "양념은 비슷한데 양파가 적어요.", 1),
        ("소고기 무국", "양념 없이 담백해요.", 2),
    ],
    "볶음밥": [
        ("계란볶음밥", "양파 없이 간단해요.", 1),
        ("김밥", "밥과 채소 위주라 부담이 덜해요.", 2),
    ],
    "김치볶음밥": [
        ("계란볶음밥", "김치와 양파를 뺐어요.", 1),
        ("김밥", "밥과 채소 위주라 부담이 덜해요.", 2),
    ...
    "삼겹살": [
        ("오징어 숙주볶음", "마늘 없이 담백해요.", 1),
        ("소고기 무국", "기름기가 덜해요.", 2),
    ],
    "닭갈비": [
        ("닭가슴살 구이", "양념 없이 담백해요.", 1),
        ("오징어 숙주볶음", "매운 양념이 없어요.", 2),
    ],
    "갈비탕": [
        ("소고기 무국", "마늘이 거의 없어요.", 1),
        ("미역국", "국물이 순해요.", 2),
    ...
    "파스타": [
        ("쌀국수", "밀 대신 쌀로 만든 면이에요.", 1),
        ("오징어 숙주볶음", "면 대신 담백하게.", 2),
    ],
    "피자": [
        ("계란볶음밥", "밀과 치즈를 뺐어요.", 1),
        ("김밥", "가볍게 한 끼로.", 2),
